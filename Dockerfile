...
RUN echo "install.packages(c('restatapi','rdbnomics','RJSDMX','TSsdmx','ggiraph','ggnetwork','ggTimeSeries','plotrix','rsdmx','shinyjs','TSdbi','timeSeries','flagr','ggdemetra','eurostat','tmap'),repos='https://cloud.r-project.org')" > /tmp/install.R && \
